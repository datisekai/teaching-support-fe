<template>
  <div>
    <el-tabs class="full-width" v-model="activeName">
      <el-tab-pane label="Thuộc tính phiên bản" name="variant">
        <div class="row">
          <div
            ...
            v-for="variantAttribute of variantAttributes"
          >
            <div class="card">
              ...
              <div class="card-body card-body-attribute">
                <el-table :data="variantAttribute.options" style="width: 100%">
                  <el-table-column prop="name" label="Tiêu đề">
                  </el-table-column>
                  <el-table-column class-name="td-actions" label="Hành động">
                    <template slot-scope="props">
                      <p-button
                        type="primary"
                        size="sm"
                        icon
                        @click="showModal(props.row, 'edit')"
                      >
              ...
              <div class="card-body">
                <el-button
                  ...
                  size="small"
                  class="full-width"
                  @click="showModal(variantAttribute, 'add')"
                  >Thêm mới</el-button
                >
              </div>
            </div>
      ...
      <el-tab-pane label="Thuộc tính sản phẩm" name="product">
        <div class="row">
          <div
            class="col-lg-4 col-md-6 col-sm-6 col-xs-12 card-attribute"
            v-for="productAttribute of productAttributes"
          >
            <div class="card">
              <div class="card-header">
                <h6 class="card-title text-center">
              ...
              <hr />
              <div class="card-body card-body-attribute">
                <el-table :data="productAttribute.options" style="width: 100%">
                  <el-table-column prop="name" label="Tiêu đề">
                  </el-table-column>
                  <el-table-column class-name="td-actions" label="Hành động">
                    <template slot-scope="props">
              ...
              <div class="card-body">
                <el-button
                  ...
                  size="small"
                  class="full-width"
                  @click="showModal(productAttribute, 'add')"
                  >Thêm mới</el-button
                >
              </div>
            </div>
      ...
      <el-tab-pane label="Màu sắc" name="color" v-if="colorAttributes.length">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 card-attribute">
          <div class="card">
            ...
            <hr />
            <div class="card-body card-body-attribute">
              <el-table :data="colorAttributes" style="width: 100%">
                <el-table-column prop="name" label="Tiêu đề" minWidth="180">
                </el-table-column>
                <el-table-column prop="value" label="Giá trị" minWidth="120">
                  <template slot-scope="props">
                    <input
                      type="color"
    ...
    <el-dialog
      title="Thuộc tính"
      :visible.sync="dialogEditAttribute"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        >
        <el-button v-else type="primary" @click="updateOption"
          >Cập nhật</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    createOption() {
      ...
      this.$store
        .dispatch("storeAttributeOptions", this.formModalAttribute)
        .then(
          res => {
            if (res.success) {
              Message({
    ...
    updateOption() {
      ...
      this.$store
        .dispatch("updateAttributeOptions", this.formModalAttribute)
        .then(
          res => {
            if (res.success) {
              Message({
    ...
    removeOption(id) {
      MessageBox.confirm("Xóa thuộc tính?", "warning", {
        ...
        .then(() => {
          this.$store.dispatch("removeAttributeOptions", id).then(
            res => {
              if (res.success) {
                Message({
                  message: "Đã xóa",
