  ...
  <div class="row">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="storeMeta" :disabled="!formCreateMeta.metaKey || !formCreateMeta.metaValue">{{$t('el.button.create')}}</el-button>
      </span>
    </el-dialog>
    <el-dialog 
      width="700px" 
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="updateMeta" :disabled="!formUpdateMeta.metaKey || !formUpdateMeta.metaValue">{{$t('el.button.update')}}</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    storeMeta() {
      this.$store.dispatch('storeMeta', this.formCreateMeta).then((res) => {
        Notification ({
          title: 'Success',
    ...
    updateMeta() {
      this.$store.dispatch('updateMeta', this.formUpdateMeta).then((res) => {
        Notification ({
          title: 'Success',
