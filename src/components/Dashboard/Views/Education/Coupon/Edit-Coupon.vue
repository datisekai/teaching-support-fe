        ...
        <div class="card-body form-card">
          ...
          <div class="row">
            <div class="col-sm-12 p-0">
              ...
              <span
                v-if="educationCouponDetail.isExpired"
          ...
          <div v-if="form.discountType != 'free_shipping'">
            ...
            <div class="row">
              <div class="col-sm-12 p-0">
                <label
                  :class="
                    educationCouponDetail.type !== 'birthday' ? 'required' : ''
                  "
  ...
  computed: {
    ...
    currentTypeRelationTitle() {
      const typeRelation = this.$util
        .getOptions("typeRelation")
        .find(t => t.value === this.educationCouponDetail.typeRelation);
    ...
    save() {
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          this.$store.dispatch("updateEducationCoupon", data).then(
            res => {
              Notification({
                title: "Success",
