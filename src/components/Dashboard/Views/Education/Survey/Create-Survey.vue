        ...
        <div class="card-body form-card">
            ...
            <div class="row">
                <div class="col-sm-12 p-0">
                    ...
                    <select-ajax
                        ...
                        :attribute="{type: 'coupons', field: 'code', key: 'id', valueKey: 'id', initOptions: initOptionsCoupon, extraQuery: {department: 'education'}}"
                    >
                    </select-ajax>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 p-0">
                    ...
                    <div class="col-sm-12 p-0">
                        <ul>
                            <li v-for="(question, index) in form.questions" :key="index" class="each-question">
                                <div>
                                    <div><strong>Câu {{ index+1 }}:</strong> {{ question.content }}</div>
                        ...
                        <el-button type="text" @click="dialogVisible.create = true">Thêm câu hỏi</el-button>
                        <el-dialog
                            title="Thêm câu hỏi"
                            ...
                            <div class="el-form-item">
                                ...
                                <el-input type="textarea" v-model="newQuestion.content" placeholder="Nhập câu hỏi vào đây!"></el-input>
                            </div>
                        ...
                        <el-dialog
                            ...
                            width="30%"
                           >
                            <el-input type="textarea" v-model="selectedQuestion.content" placeholder="Nhập câu hỏi vào đây!"></el-input>
                            <span slot="footer" class="dialog-footer">
                                <el-button @click="dialogVisible.edit = false">Cancel</el-button>
...
export default {
  ...
  methods: {
    ...
    async save() {
        ...
        try {
            let res = await this.$store.dispatch('createSurvey', Object.assign({}, form, {department: 'customer_service'}));
            for (const question of form.questions) {
                await this.$store.dispatch('createQuestionSurvey', Object.assign({}, {surveyId: res.id}, question));
            }
            Notification({
                title: 'Success',
