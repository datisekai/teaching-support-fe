        ...
        <div class="card-body form-card">   
          <div class="row">
            <div class="col-sm-12 p-0">
              ...
              >
                <el-button id="new-code" slot="append" icon="fa fa-retweet" @click="genNewCode"></el-button>
              </el-input>
          ...
          <div class="row" v-if="!form.forGiveAway">
            <div class="col-sm-12 p-0">
              <my-money
                ...
                :disabled="!form.isLimitUsageTimes"
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch('setPageTitle', 'couponCreate');
    ...
    save() {
      this.$validator.validateAll().then((result) => {
        if (result) {
          ...
          this.$store.dispatch('createCSCoupon', Object.assign({}, data, {department: 'customer_service'})).then((res) => {
            Notification ({
              title: 'Success',
            ...
            setTimeout(() => {
              this.$router.push('/cs/coupon/' + res.id);
            }, 500);
          }, (err) => {
            Notification ({
              title: 'Error',
  ...
  watch: {
    ...
    'form.forGiveAway': function(newVal) {
      if (newVal === true) {
        this.form.limitUsage = 0;
        this.form.isLimitUsageTimes = false;
        this.form.isLimitUsagePerCustomer = true;
      }
    }
  },
  destroyed() {
