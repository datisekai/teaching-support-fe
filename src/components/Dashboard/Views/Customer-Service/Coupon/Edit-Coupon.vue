        ...
        <div class="card-body form-card">
          ...
          <div v-if="form.discountType != 'free_shipping'">
            ...
            <div class="row">
              <div class="col-sm-12 p-0">
                <label
                  :class="csCouponDetail.type !== 'birthday' ? 'required' : ''"
  ...
  computed: {
    ...
    currentTypeRelationTitle() {
      const typeRelation = this.$util
        .getOptions("typeRelation")
        .find(t => t.value === this.csCouponDetail.typeRelation);
    ...
    save() {
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          this.$store.dispatch("updateCSCoupon", data).then(
            res => {
              Notification({
                title: "Success",
