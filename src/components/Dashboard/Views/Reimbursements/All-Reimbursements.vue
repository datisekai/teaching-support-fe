...
export default {
  ...
  data() {
    const initFiledArrays = ['id', 'receiptNo', 'notebook', 'customer_name', 'returnedAt', 'actualReturnedAt', 'reimbursementFormStatus'];
    const columnDefs = dtHelper.buildInitFields(reimbursementForm, initFiledArrays);
